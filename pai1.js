...
var token = 'LOGIN_f7f93b97-bcfa-4d0d-9643-e69fb034d09d';
...
getOpt = function (f) {
    ...
    var opt = {
        ...
        headers: {
            ...
            "appid": "1002",
            "patchid": "1",
            "deviceid": "865790021813936",
            "version": "13",
            "mobileosversion": "4.4.4",
            "User-Agent": "Dalvik/1.6.0 (Linux; U; Android 4.4.4; YQ601 Build/KTY84P)",
    ...
    if (f == 'sync') {
        ...
        url = 'http://gogobids.com/api/period/2/refresh?periods=' + periodId;
        opt['url'] = url;
    } else if (f == 'buy') {
